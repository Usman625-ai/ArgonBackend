...
public class DataLoader implements CommandLineRunner {
    ...
    private void step1_createUsers() {
        ...
        users.put("seller5", reg("Faisal Qureshi", "seller5@shop.com", Role.SELLER, "GadgetHub Pakistan"));
        users.put("seller6", reg("Ayesha Raza", "seller6@shop.com", Role.SELLER, "Trendy Threads"));
        users.put("seller7", reg("Hamza Iqbal", "seller7@shop.com", Role.SELLER, "FitLife Sports"));
        users.put("seller4", reg("Zara Malik", "seller4@shop.com", Role.SELLER, "VipSetup"));
        users.put("seller8", reg("Mahnoor Shah", "seller8@shop.com", Role.SELLER, "GlowUp Beauty"));
